...
type CustomButtonVariant = 'primary' | 'secondary' | 'ghost' | 'danger' | 'danger-soft'
...
})<{ customVariant?: CustomButtonVariant }>(({ theme, customVariant }) => {
    const baseStyles = {
      textTransform: 'none',
      fontWeight: 600,
      fontSize: '15px',
...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', ...props }, ref) => (
    <StyledButton ref={ref} {...props} customVariant={variant} />
  ),
)
